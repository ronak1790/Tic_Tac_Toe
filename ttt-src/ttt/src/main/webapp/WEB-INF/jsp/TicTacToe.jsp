...
<body>
	<h1 align="center">
		...
		<font face="Times New Roman">1 Player Game</font>
	</h1>
	...
	<h3>
		<p class="uppercase" align="center" bgcolor="#006600">Welcome
			${username}</p>
	</h3>
	...
	<h2 align="center">
		<p align="center" style="color: #CC0033">${message}</p>

		<a href="ttt.html" class="navigation">New Game</a>
		
		<a href="history.html" class="navigation">Game History</a>
		
		<c:if test="${message eq 'Please make your move:'}">
		
		<a href="save.html" class="navigation">Save This Game</a>
	</c:if>
		<c:if test="${message ne 'Please make your move:'}">
		
			<a href="savesgame.html" class="navigation">Open Saved Games</a>
	</c:if>
		
		<a  href="GameHome.html" class="gotohome">Go to home</a>
			<h3 align="center"><a href="ttt/j_spring_security_logout" class="logout">LogOut</a></h3>
	
	</h2>
	
	
	<!-- new before for button -->
	...
	<h2 align="center">
		...
		<a align="center" href="ttt.html" style="color: blue">New Game</a>&nbsp
		&nbsp &nbsp <a align="center" href="history.html" style="color: blue">Game
			History</a> &nbsp &nbsp &nbsp
		<c:if test="${message eq 'Please make your move:'}">
			<a href="save.html" style="color: blue">Save This Game</a>&nbsp &nbsp &nbsp
	</c:if>
		<c:if test="${message ne 'Please make your move:'}">
			<a href="savesgame.html">Open Saved Games</a> &nbsp &nbsp &nbsp
	</c:if>
		<a href="GameHome.html" style="color: blue">Go to home</a>&nbsp &nbsp
		&nbsp </br>
			<h3 align="center"><a href="logout.html" class="logout">Logout</a></h3>
